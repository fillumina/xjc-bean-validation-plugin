...
class OverrideFixtureTest extends FixtureTest {
    ...
    static Stream<Case> cases() {
        return Stream.of(
                ...
                Case.of("OverrideSelectsAPropertyWithACharacterClass", namespace(), override("*#cod[e]")),
                Case.of("OverrideSelectsAPropertyWithARange", namespace(), override("*#childr[a-z]n")),
                Case.of("OverrideSelectsWithAClassAndANegatedCharacterClass", namespace(),
                        override("a.RootTyp[e]#labe[!x]")),
                Case.of("OverrideSelectsWithACharacterClassAndSetsAParameter", namespace(),
                        override("*#labe[l]@Size:max = 5")),
                ...
                Case.of("OverrideReadsAFieldPlaceholderFromTheFieldAnnotation", namespace(),
                        override("*#label*@Size=@Size(min = 2, max = {max})")),
                Case.of("OverrideReadsAnItemPlaceholderFromTheItemAnnotation", namespace(),
                        override("*#labels@List.Size:message = at most {max}")),
